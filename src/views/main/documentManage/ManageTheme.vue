<template>
  <div class="manage-theme">
    <div class="add">
      <el-button type="primary" @click="showAddDialog">添加主题</el-button>
    </div>
    <el-table :data="themeData" border style="width: 100%">
      ...
      <el-table-column prop="description" label="主题描述"></el-table-column>
    ...
    <!-- 编辑主题的对话框 -->
    <el-dialog :title="switchDialog ? '添加主题' : '编辑主题'" :visible.sync="editDialogVisible">
      <el-form :model="form">
        ...
        <el-form-item label="主题描述" :label-width="formLabelWidth">
          <el-input
            ...
            autocomplete="off"
            type="textarea"
          >{{ switchDialog ? '' : form.description }}</el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    // 删除主题
    deleteTheme(id) {
      MessageBox.confirm('此操作将永久删除该文档主题, 是否继续?', '提示', {
