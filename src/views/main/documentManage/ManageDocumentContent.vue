<template>
  <div class="manage-document-content">
    ...
    <el-table :data="themeData" border style="width: 100%">
      ...
      <el-table-column prop="domPage" label="所属文档页"></el-table-column>
      <el-table-column prop="domTitle" label="文档标题"></el-table-column>
    ...
    <!-- 编辑主题的对话框 -->
    <el-dialog :title="switchDialog ? '添加文档内容' : '编辑文档内容'" :visible.sync="editDialogVisible">
      <el-form :model="form">
        ...
        <el-form-item label="所属文档页" :label-width="formLabelWidth">
          <el-input
            v-model="form.domPage"
            autocomplete="off"
          >{{ switchDialog ? '' : form.domPage }}</el-input>
        </el-form-item>
        <el-form-item label="文档标题" :label-width="formLabelWidth">
          <el-input
            v-model="form.domTitle"
            autocomplete="off"
          >{{ switchDialog ? '' : form.domTitle }}</el-input>
        </el-form-item>
        <!-- 文档内容 -->
      </el-form>
...
export default {
  ...
  methods: {
    ...
    showEditDialog(data) {
      ...
      this.form.domPage = data.domPage
      this.form.domTitle = data.domTitle
      this.form.domContent = data.domContent
